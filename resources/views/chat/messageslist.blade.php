...
@foreach($user2 as $u)
 		...
 		<b>
		<a class="disable-linkstyle" href="/messages/userid/{{$message->uid2}}" style="text-decoration: none;  color: black;">
		 <div class="card" id="">
		 	<div class="card-body">
	...
	<a class="disable-linkstyle" href="/messages/userid/{{$message->uid2}}" style="text-decoration: none; color: black;">
		 <div class="card" id="">
		 	<div class="card-body">
				...
				<img src="/public/storage/default_image/avatar.png " class="" style="width: 50px; height: 50px; border-radius: 100%; border: 1px solid black;">
		        @else
				<img src="/public/storage/profile_image/{{$u->id}}/{{$u->profile_image}} " class="" style="width: 50px; height: 50px; border-radius: 100%; border: 1px solid black;">
		        @endif
