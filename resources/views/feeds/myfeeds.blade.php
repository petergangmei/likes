...
<footer class="blockquote-footer">Posted by <cite title="Source Title"><a href="/profileid-{{$p->user_id}}">{{$p->user_name}}</a></cite></footer>
  ...
  <div class="card-footer ">
  	...
  	<span class="float-left" style="margin: 4px -7px;">{{$p->likes}}</span>
  	<a href="/viewpost{{$p->id}}"> <i class="fa fa-comment-o cursor-pointer float-left" style="font-size: 21px; margin: 3px 7px;"></i></a>
